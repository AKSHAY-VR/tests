...
async function loadExcelData() {
    const sheetUrl = 'https://docs.google.com/spreadsheets/d/1_q6IaRErhJnPM_pTwiI7pGvOTJ4PJJRMTaz4zr-rmio/export?format=xlsx';
    try {
...
function updateChartWithFilter() {
    ...
    selectedTopicsDiv.innerHTML = `Selected Topics: ${[...selectedTopics].join(', ') || 'Social Protection, Infrastructure, Other, Trade and Export, Agriculture, Economic Growth, Governance, Law and Order, Education, Health, Reconciliation, Corruption, Labour, IMF Programme, Taxation'}`;
