...
async function loadExcelData() {
    const sheetUrl = 'https://docs.google.com/spreadsheets/d/1jF0sSpd3ciIDSXId4kvynPq42P0G8m-MRDjyhRs3Vss/export?format=xlsx';
    try {
...
function createTopicFilter() {
    ...
    allLabel.textContent = 'அனைத்தும்';
...
function updateChartWithFilter() {
    ...
    selectedTopicsDiv.innerHTML = `Selected Topics: ${[...selectedTopics].join(', ') || 'சமூகப் பாதுகாப்பு, உட்கட்டமைப்பு, ஏனைய, வர்த்தகம் மற்றும் ஏற்றுமதி, விவசாயம், பொருளாதார வளர்ச்சி, ஆளுகை, சட்டமும் ஒழுங்கும், கல்வி, சுகாதாரம், நல்லிணக்கம், ஊழல், தொழிலாளர், சர்வதேச நாணய நிதியத் திட்டம், வரிவிதிப்பு'}`;
