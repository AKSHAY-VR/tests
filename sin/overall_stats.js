...
function createTransposedTable(topics, candidates) {
    ...
    headerRow.append("th")
        ...
        .html("මාතෘකා<br/><span class='sub-header'>අධීක්‍ෂණය කළ හැකි ක්‍රියා/සියලු ක්‍රියා</span>");
...
loadExcelFromGoogleSheet('https://docs.google.com/spreadsheets/d/1eH2VMrD_qDk8fFhxbqlI4AwVW9SaIexPvH1cr-NP8EE/export?format=xlsx');